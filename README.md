...
software development workflows. Strong interest in Cybersecurity, Backend Engineering, and Software Systems
...
[July – October 2025]
Translated UI/UX wireframes and mockups into production-ready front-end code, ensuring cross-device
compatibility and brand consistency.
• 
Integrated third-party component libraries to accelerate development while maintaining design system
coherence.
Shadowed client inventory and transaction workflows to understand real-time data requirements.
...
Verse Telecoms
2024
Supported telecommunications operations involving fiber-optic service deployment, network troubleshooting, and
customer support functions.
• 
Assisted in Optical Network Terminal (ONT) installation, configuration, testing, and service activation processes.
...
Delivered classroom instruction, facilitated student discussions, evaluated assignments, and provided structured
academic feedback.
• 
